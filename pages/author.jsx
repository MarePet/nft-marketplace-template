...
const author = () => {
  ...
  return (
    <div>
      ...
      <AuthorProfileCard/>
      <AuthorTaps collectibles = {collectibles} created ={created} like = {like} following = {following}/>
      <Title heading="Popular Creators" paragraph="Click on music icon and enjoy NFT music."/>
